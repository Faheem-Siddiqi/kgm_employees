...
public final class EmployeeInductionHelper {
    ...
    private EmployeeInductionHelper() {
    }

    public static void applyFrame(JFrame frame) {
        EmployeeInductionStyle.applyFrame(frame);
    }

    public static JPanel createTopContainer() {
        return EmployeeInductionStyle.createTopContainer();
    }

    public static JPanel createBackRow() {
        return EmployeeInductionStyle.createBackRow();
    }

    public static void styleBackButton(JButton button) {
        EmployeeInductionStyle.styleBackButton(button);
    }

    public static JPanel createCenterWrapper() {
        return EmployeeInductionStyle.createCenterWrapper();
    }

    public static void styleFooterButton(JButton button) {
        EmployeeInductionStyle.styleFooterButton(button);
    }
