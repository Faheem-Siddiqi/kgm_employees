...
public class EmployeeAdditionalDetailsPanel extends JPanel {
    ...
    private void installBreadcrumbLinks(JPanel breadcrumb, String[] labels, JComponent[] targets) {
        for (int index = 0; index < labels.length; index++) {
            JButton link = EmployeeAdditionalDetailsPanelHelper.createBreadcrumbLink(labels[index]);
    ...
    private JPanel createField(String label, String value) {
        ...
        JPanel p = EmployeeAdditionalDetailsPanelHelper.createFieldPanel();

        JLabel lbl = EmployeeAdditionalDetailsPanelHelper.createFieldLabel(label);
